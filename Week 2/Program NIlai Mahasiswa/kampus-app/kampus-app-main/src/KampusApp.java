...
public class KampusApp {
    ...
    public void menuTambahProdi() {
        ...
        System.out.println("Prodi " + prodi.getNama() + " telah ditambahkan.");
    ...
    public void menuTambah() {
        ...
        System.out.println("Mahasiswa dengan nama " + mahasiswa.getNama() + " telah ditambahkan.");
        System.out.println("Tekan Enter untuk melanjutkan...");
        scanner.nextLine();
        showMenu();
    }
    ...
    public void menuCari() {
        ...
        if (mahasiswa == null) {
            ...
            Prodi prodi = db.prodiTbl.getProdiById(prodiID); 
            if (prodi != null) {
